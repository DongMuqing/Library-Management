<?php /*a:1:{s:73:"C:\Users\susu\Desktop\php-booksys\application\index\view\book\search.html";i:1686109701;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  ...
  <section class="header">
    ...
    <form action="<?php echo url('book/search'); ?>" method="post" class="search">
      <div class="input-group">
        <input type="search" placeholder="请输入查询的书名" name="name">
        <button class="seabtn"> <img src="/static/img/search.png"></button>
      </div>
    </form>
    <button class="add"><a href="<?php echo url('book/add'); ?>">添加</a></button>
  </section>
  <section class="shell">
    <table>
      <thead>
